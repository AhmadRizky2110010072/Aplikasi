...
public class Pendaftaran extends javax.swing.JFrame {
    ...
    public Pendaftaran() {
        ...
        while (rs.next()){
         ...
         String idpendaftaran = String.valueOf(rs.getString("idpendaftaran"));
         ...
         String tbpendaftaran[] = {idpendaftaran, nis, nama, jeniskelamin, alamat, };
         DefaultTableModel tampilModel = (DefaultTableModel) tblpendaftaran.getModel();

         tampilModel.addRow(tbpendaftaran);
         }
    ...
    private void initComponents() {
        ...
        tblpendaftaran.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID PENDAFTARAN", "NIS", "NAMA", "JENIS KELAMIN", "ALAMAT"
            }
        ));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(tfId, javax.swing.GroupLayout.DEFAULT_SIZE, 221, Short.MAX_VALUE)
                            .addComponent(tfNis)
                            .addComponent(tfNama)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(rbLaki)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(rbPerempuan, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        ...
        tfNama.getText().equals("") || tfAlamat.getText().equals("")) {
    ...
    if (IDSudahAda) {
        ...
        try {
            pst = con.prepareStatement("INSERT into pendaftaran (idpendaftaran, nis, nama, jeniskelamin, alamat) values(?,?,?,?,?)");
            int idpendaftaran = Integer.parseInt(tfId.getText());
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        ...
        int ubah = JOptionPane.showConfirmDialog(null, "Anda yakin mengubah data?", "Konfirmasi", JOptionPane.YES_NO_OPTION);
            ...
            pst = con.prepareStatement("UPDATE pendaftaran SET idpendaftaran=?, nis=?, nama=?, jeniskelamin=?, alamat=? WHERE idpendaftaran=?");
            pst.setString(1, tfId.getText());
            pst.setString(2, tfNis.getText());
            pst.setString(3, tfNama.getText());
            if (rbLaki.isSelected()) {
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        int ubah = JOptionPane.showConfirmDialog(null, "Anda yakin menghapus data?", "Konfirmasi", JOptionPane.YES_NO_OPTION);
         ...
         // Menghapus data dalam database
            try {
            pst = con.prepareStatement("DELETE FROM pendaftaran WHERE idpendaftaran=?");
            pst.setString(1, tfId.getText());
            pst.executeUpdate();
            ...
            int getSelectedRowForDeletion = tblpendaftaran.getSelectedRow();
